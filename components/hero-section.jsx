...
export default function HeroSection() {
  return (
    <section className="ss:flex flex-col w-full relative pl-40">
      <Image
        src={mobileHeroImage}
      ...
      <div className="absolute lg:top-8 ss:top-16 top-50  lg:w-[70%] lg:h-[528px] ss:w-[70%] ss:h-[398px] w-[327px] h-[244px] pt-6 z-10">
        ...
        <p className="lg:text-body sm:text-regular text-regular lg:w-[540px] lg:h-[96px] lg:mb-14 lg:my-2 ss:my-6 ss:mb-12 mb-8 ss:w-[426px]">
